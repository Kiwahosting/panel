...
const MOD = require('@material-ui/core/ButtonBase/TouchRipple');
MOD.default = withStyles(styles, { flip: false, name: 'MuiTouchRipple' })(TouchRipple);
